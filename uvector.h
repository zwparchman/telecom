 ...
 * @copyright AndrÃ© Offringa, 2013, distributed under the GPL license version 3.
 */
...
public:
	 ...
	 */
	uvector(const allocator_type& allo = Alloc()) noexcept
	: Alloc(allo), _begin(nullptr), _end(nullptr), _endOfStorage(nullptr)
	{
	}
...
private:
	...
	void deallocate(pointer beg, size_t n)
	{
		if(beg != nullptr)
	...
	void swap(uvector<Tp,Alloc>& other, std::false_type)
	{
		 ...
		 * of a call to a containerâ€™s swap function is undefined unless the objects being
